...
def create_baseline_features(patient_df, feature_columns):
    ...
    # Only compute rolling/trend on vital sign value columns (first 8 of 40 raw features)
    ...
    # Rolling stats: mean, min, max, std per vital
    ...
    for t in range(n_hours):
        ...
        for j, vi in enumerate(vital_indices):
            ...
            # Linear regression slope: fit y = a*x + b, return a
            if len(segment) >= 2:
